  ...
  <div class="sub-header">
    <div class="sub-header-profile">
      <div class="profile-column">
        ...
        <div class="sub-header-profile-name">Paulo Ojeda</div>
      </div>
      <div class="company-column">
        <img class="company-logo" src="{base}/images/cust-logo1.png" alt="company-logo">
        <div class="sub-header-role">( Fleet Technician )</div>
      </div>
    </div>
  </div>
